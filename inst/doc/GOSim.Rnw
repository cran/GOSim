...
<<results=verbatim>>=
IC[c("GO:0007166","GO:0007267","GO:0007584","GO:0007165","GO:0007186")]/max(IC[IC!=Inf]) # only consider terms with available annotation!
@
...
analyzeCluster(c("8614", "9518", "780", "2852"), allgenes) # print out what cluster 1 is about
@
